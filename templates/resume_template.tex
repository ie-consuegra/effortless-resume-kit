%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% TEMPLATE: Resume (resume.cls) -- structural reference for The agent generation
% Copy this structure exactly. Replace [GENERATE: ...] placeholders with Job descriptions-tailored content.
% FIXED sections: contain actual data -- never modify during generation
% GENERATE sections: The agent fills in per Job descriptions using the uploaded bundle
%
% SETUP INSTRUCTIONS:
% 1. Fill [CONFIG: ...] markers with values from your config.md
% 2. Fill FIXED sections (Education, Awards, etc.) with your actual content
% 3. Leave [GENERATE: ...] markers -- The agent fills these per Job descriptions
...
% GENERATE: Relocation target per Job descriptions
\address{[CONFIG: City, State] (Open to relocation to [Target City])}
% GENERATE: Tagline -- rewrite per Job descriptions using bundle Section 2 building blocks
...
%----------------------------------------------------------------------------------------
%	GENERATION REFERENCE (for The agent -- not rendered in PDF)
%----------------------------------------------------------------------------------------
...
%   Bold line = Job descriptions-customized domain theme (strongest customization lever)
...
%----------------------------------------------------------------------------------------
%	SUMMARY — GENERATE per Job descriptions
%----------------------------------------------------------------------------------------
% GENERATE: Rewrite per Job descriptions using bundle Section 2 building blocks
...
[GENERATE: [Domain] scientist with [N]+ years combining \textbf{[primary method]} and \textbf{[secondary method]} for [application domain]. [1-2 sentences on key accomplishments tailored to Job descriptions]. [Metrics: publications, citations, awards if applicable].]
\end{rSection}
\vspace{-0.15cm}

%----------------------------------------------------------------------------------------
%	TECHNICAL SKILLS — GENERATE per Job descriptions (Format C)
%----------------------------------------------------------------------------------------
% GENERATE: 5 groups in Format C (categorized dash sub-items)
% Default config from config.md (e.g. 4-3-2-2-2 = 13 content lines)
% Load skills_taxonomy.md to map Job descriptions keywords to skill entries
% Group names are Job descriptions-customizable; order most Job descriptions-relevant first
% Bold 6-8 tools that most directly match Job descriptions keywords
...
\begin{skillgroup}{[GENERATE: Most Job descriptions-Relevant Domain]}
...
%----------------------------------------------------------------------------------------
%	EXPERIENCE — GENERATE bullets per Job descriptions; position headers are FIXED
%----------------------------------------------------------------------------------------
% Add one rSubsection per position. Most recent first.
% FLIPPED format: Bold line = Job descriptions-customized theme; italic = formal role + institution.
% Mark any position as FIXED if its bullets never change across Job descriptionss.
\begin{rSection}{Experience}

% --- Position 1 (most recent) ---
% GENERATE: Select bullets from bundle; bold theme line customized to Job descriptions
\begin{rSubsection}{[GENERATE: Job descriptions-Customized Theme]}{\textcolor{black!60}{[FIXED: Start -- End]}}{[FIXED: Title, Institution]}{}
\item [GENERATE: Bullet 1 -- strongest Job descriptions-relevant accomplishment]
...
%----------------------------------------------------------------------------------------
%	EDUCATION — FIXED: Fill with relevant actual education
%----------------------------------------------------------------------------------------
% Each entry: {Degree / program} \hfill {Years} \\ {Institution}, Location

\begin{rSection}{Education}
{Acting (Drama School)} \hfill {\textcolor{black!60}{Sep 1997 -- Jun 1999}}\\
{The Poor School}, London, UK

{Psychology (University)} \hfill {\textcolor{black!60}{Sep 1996 -- Jun 1997}}\\
{University College London}, London, UK
\end{rSection}
\vspace{-0.15cm}

%----------------------------------------------------------------------------------------
%\tLEADERSHIP & VOLUNTEERING — FIXED: Fill with your actual entries
%----------------------------------------------------------------------------------------
% Format: \item \textbf{Organization} (Dates). Role + concise contribution summary.
% Aim for 1 rendered line each. Keep claims externally safe and source-backed.

\begin{rSection2}{Leadership \& Volunteering}
\item \textbf{[FIXED: Organization]} ([FIXED: Dates]). [FIXED: Role and contribution summary].
\end{rSection2}
\vspace{-0.15cm}

%----------------------------------------------------------------------------------------
%	SELECTED PUBLICATIONS — GENERATE: The agent picks 5 per Job descriptions relevance
%----------------------------------------------------------------------------------------
% GENERATE: Score publications per Job descriptions relevance using pub_metadata.md
% Copy-paste FIXED author + journal LaTeX blocks from pub_metadata.md
% GENERATE Job descriptions-shortened title + Job descriptions-relevant keyword tags at runtime
...
\item [GENERATE: Publication 1 -- most Job descriptions-relevant, short format]
...
%----------------------------------------------------------------------------------------
%	IMMIGRATION — FIXED content, include/exclude per Job descriptions
%   USA Job descriptions: keep this block | Non-USA Job descriptions: delete (frees ~2 lines)
%----------------------------------------------------------------------------------------
