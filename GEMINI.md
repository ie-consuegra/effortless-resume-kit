# gemini-resume-kit — Project Instructions

> This file is auto-loaded by Gemini CLI. It provides project-wide rules for all skills.
> **NEVER EDIT THIS FILE.** `GEMINI.md` is a read-only system file. Do not write session state, user data, job titles, company names, or any runtime content here. All mutable state belongs in `config.md`.
